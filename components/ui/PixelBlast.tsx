...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  // 1. Intersection Observer untuk pause/resume animasi otomatis saat (offscreen/onscreen)
  useEffect(() => {
  ...
  // 2. Setup dan Teardown konteks WebGL
  useEffect(() => {
    ...
    return () => {
      ...
      cancelAnimationFrame(raf); // Gunakan variabel 'raf' dari closure, bukan 't.raf!'
  ...
  // 3. Re-Sync parameter dan properties (hanya mengubah state tanpa membuat ulang WebGL)
  useEffect(() => {
